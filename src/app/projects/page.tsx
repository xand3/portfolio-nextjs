    ...
    <MainArea>
      <LeftArea myClasses="col-end-4 justify-items-stretch">
        ...
        <div className={`grid grid-cols-2 grid-rows-auto gap-y-12 gap-x-8 max-sm:grid-cols-1 max-sm:gap-y-28`}>
          ...
          <Project imgSrc={"/images/pokedex.png"} title={"Pokedex"} description={"In this project, I have developed an online Pokédex: a virtual encyclopedia that contains all Pokémon species."} repositoryLink={"https://github.com/xand3/pokedex-dioBootcamp"} projectLink={"https://xand3.github.io/pokedex-dioBootcamp/"} />
